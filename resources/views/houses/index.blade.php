    ...
    <div class="container">
        <div class="row text-center" style="padding: 5px;">
            <div class="col-sm-6 pull-left" style="margin-bottom: 5px;">
                <a href="{{ route('house.all-listings') }}" role="button" class="btn btn-primary">Back to All Listings</a>
            </div>
            <div class="col-sm-6 pull-right" style="margin-bottom: 5px;">
                <a href="{{ route('houses.create') }}" role="button" class="btn btn-primary">Create New Listing</a>
            </div>
        </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 text-right" style="padding: 0;">
                                                    <a href="{{ route('houses.edit', $house->id) }}" role="button" class="btn btn-primary">Edit</a>
                                                    ...
                                                    <form
                                                        method="post"
                                                        action="{{ route('houses.destroy', $house->id) }}"
